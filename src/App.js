      ...
      {lights.map((e)=> {
        return (
          <div className={`menu-item ${activeLight == e[1].name ? 'active-item' : ''}`} data-value={e[1].name} onClick={changeLight}>
            {e[1].modelid == 'LCL001' ?           <svg onClick={changeLightOfIconClick} width="32px" height="32px" viewBox="0 0 32 32" version="1.1">
...
: <svg onClick={changeLightOfIconClick} width="32px" height="32px" viewBox="0 0 32 32" version="1.1">
<g stroke="gray" stroke-width="1" fill="none" fill-rule="evenodd">
    <g fill="#1c1e24">
