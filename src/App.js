...
const Image = (props) => {
  ...
  return <img className='light-image' alt="Selected light icon" src={image} />;
};
const Light = (props) => {
...
function App() {
  ...
  return (
    <div className='App'>
      ...
      {lights.map((e)=> {
        return (
          <div key={e[1].name} className={`menu-item ${activeLight == e[1].name ? 'active-item' : ''}`} data-value={e[1].name} onClick={changeLight}>
...
<g stroke="#1c1e24" strokeWidth="1" fill="none" fillRule="evenodd">
    <g fill="gray">
